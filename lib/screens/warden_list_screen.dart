...
import 'warden_edit_screen.dart';

class WardenListScreen extends StatefulWidget {
  final String title;
  final String dataKey;

  const WardenListScreen({
    Key? key,
    required this.title,
  ...
  @override
  State<WardenListScreen> createState() => _WardenListScreenState();
}

class _WardenListScreenState extends State<WardenListScreen> with SingleTickerProviderStateMixin {
          ...
          child: Column(
            ...
            children: [
              ListTile(
                ...
                title: const Text('Edit Warden', style: TextStyle(fontWeight: FontWeight.w600)),
                onTap: () {
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              widget.title == 'Warden Advisors' ? 'Add New Warden Advisor' : 'Add New Warden',
