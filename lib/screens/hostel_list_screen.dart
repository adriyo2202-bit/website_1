...
class _HostelListScreenState extends State<HostelListScreen> with SingleTickerProviderStateMixin {
  ...
  void _navigateToDetail(Map<String, dynamic> item, int index) async {
    final result = await Navigator.push(
      context,
      MaterialPageRoute(
  ...
  Widget _buildItemCard(Map<String, dynamic> item, int index) {
    ...
    return GestureDetector(
      onTap: () => _navigateToDetail(item, index),
      onLongPress: () {
        showDialog(
          context: context,
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    if (item['hostelType'] != null && item['hostelType'].toString().isNotEmpty)
                      Padding(
