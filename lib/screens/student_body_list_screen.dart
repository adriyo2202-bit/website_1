...
import 'student_body_edit_screen.dart';

class StudentBodyListScreen extends StatefulWidget {
  final String title;
  final String dataKey;

  const StudentBodyListScreen({
    Key? key,
    required this.title,
  ...
  @override
  State<StudentBodyListScreen> createState() => _StudentBodyListScreenState();
}

class _StudentBodyListScreenState extends State<StudentBodyListScreen> with SingleTickerProviderStateMixin {
  ...
  Future<void> _navigateToAddItem() async {
    final result = await Navigator.push(
      context,
      MaterialPageRoute(
        builder: (_) => StudentBodyEditScreen(
          ...
          child: Column(
            ...
            children: [
              ListTile(
                ...
                title: const Text('Edit Member', style: TextStyle(fontWeight: FontWeight.w600)),
                onTap: () {
