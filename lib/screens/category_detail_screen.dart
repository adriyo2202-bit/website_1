              ...
              Container(
                ...
                decoration: const BoxDecoration(
                  gradient: LinearGradient(
                    ...
                    colors: [
                      Color(0xFFD6C8EB), // Soft purple top left
                      Color(0xFFF9F5F0), // Off-white middle
                      Color(0xFFC7D3EE), // Soft blue bottom right
                    ],
                    stops: [0.0, 0.4, 1.0],
                  ),
                ),
                    ...
                    children: [
                      Positioned(
                        ...
                        top: size.height * 0.5 +
                            ...
                            250,
                        child: _buildOrb(const Color(0xFFE5D9F2), size: 500),
                      ),
                      Positioned(
                        left: size.width * 0.5 +
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          gradient: const LinearGradient(
            ...
            colors: [
              Color(0xFFF4EBFF), // Very light pink/purple
              Color(0xFFE4EBFF), // Very light blue
            ],
          ),
          boxShadow: [
            BoxShadow(
