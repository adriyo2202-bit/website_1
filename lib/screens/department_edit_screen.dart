...
class _DepartmentEditScreenState extends State<DepartmentEditScreen> with SingleTickerProviderStateMixin {
  ...
  void _initializeData() {
    if (widget.existingItem != null) {
      ...
      _hodNameController.text = item['hodName'] ?? '';
      _hodContactController.text = item['hodContact'] ?? '';
      _hodEmailController.text = item['hodEmail'] ?? '';
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildLabel("Name"),
                  _buildGradientTextField(hint: "Name of the department", controller: _nameController),
                  ...
                  _buildLabel("Head of the Department"),
                  _buildGradientTextField(hint: "Head of the Department", controller: _hodNameController),
                  
                  _buildLabel("HoD Contact"),
                  _buildGradientTextField(
                    hint: "HoD Contact Number", 
                    controller: _hodContactController,
                    keyboardType: TextInputType.phone,
                  ),
                  
                  _buildLabel("HoD Email"),
                  _buildGradientTextField(
                    hint: "HoD Contact Email", 
