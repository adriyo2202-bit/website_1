...
import 'laboratory_edit_screen.dart';

class LaboratoryListScreen extends StatefulWidget {
  final String title;
  final String dataKey;

  const LaboratoryListScreen({
    Key? key,
    required this.title,
...
class _LaboratoryListScreenState extends State<LaboratoryListScreen> with SingleTickerProviderStateMixin {
  ...
  Future<void> _navigateToAddItem() async {
    final result = await Navigator.push(
      context,
      MaterialPageRoute(
        builder: (_) => LaboratoryEditScreen(
          ...
          child: Column(
            ...
            children: [
              ListTile(
                ...
                title: const Text('Edit Laboratory', style: TextStyle(fontWeight: FontWeight.w600)),
                onTap: () {
