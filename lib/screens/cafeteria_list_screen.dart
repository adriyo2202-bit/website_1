...
import 'cafeteria_edit_screen.dart';

class CafeteriaListScreen extends StatefulWidget {
  final String title;
  final String dataKey;

  const CafeteriaListScreen({
    Key? key,
    required this.title,
...
class _CafeteriaListScreenState extends State<CafeteriaListScreen> with SingleTickerProviderStateMixin {
  ...
  void _navigateToAdd() async {
    final result = await Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => CafeteriaEditScreen(
