...
class _ClubListScreenState extends State<ClubListScreen> with SingleTickerProviderStateMixin {
  ...
  Future<void> _navigateToDetail(int index, Map<String, dynamic> item) async {
    final result = await Navigator.push(
      context,
      PageRouteBuilder(
  ...
  Widget _buildGrid() {
    ...
    return GridView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        final images = item['images']; // Can be string or List
        String? firstImagePath;
        if (images != null) {
          if (images is List && images.isNotEmpty) {
            firstImagePath = images.first.toString();
          } else if (images is String && images.isNotEmpty) {
            firstImagePath = images;
          }
        }
