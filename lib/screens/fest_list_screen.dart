...
import 'fest_edit_screen.dart';

class FestListScreen extends StatefulWidget {
  final String title;
  final String dataKey;

  const FestListScreen({
    Key? key,
    required this.title,
  ...
  @override
  State<FestListScreen> createState() => _FestListScreenState();
}

class _FestListScreenState extends State<FestListScreen> with SingleTickerProviderStateMixin {
          ...
          child: Column(
            ...
            children: [
              ListTile(
                ...
                title: const Text('Edit Fest', style: TextStyle(fontWeight: FontWeight.w600)),
                onTap: () {
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              widget.title == 'Events' ? 'Add New Event' : 'Add New Fest',
